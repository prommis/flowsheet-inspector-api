...
```{autodoc2-docstring} idaes_fi.structfs.simple_wrap._Wrapper
```
...
{py:class}`BaseFlowsheetRunner <idaes_fi.structfs.fsrunner.BaseFlowsheetRunner>`
...
* **9**: Create a global {py:class}`FlowsheetRunner <idaes_fi.structfs.fsrunner.FlowsheetRunner>` object, here called `FS`.
...
```{autodoc2-docstring} idaes_fi.structfs.runner.Action
```

```{autodoc2-docstring} idaes_fi.structfs.runner_actions
```
...
```{autodoc2-object} idaes_fi.structfs.fsrunner.FlowsheetRunner.annotate_var
```

```{autodoc2-docstring} idaes_fi.structfs.fsrunner.FlowsheetRunner.annotate_var
:parser: myst
```
